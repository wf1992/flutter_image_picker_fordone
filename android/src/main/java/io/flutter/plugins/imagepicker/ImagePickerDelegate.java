...
public class ImagePickerDelegate
    ...
    public ImagePickerDelegate(
        ...
        this.permissionManager = new PermissionManager() {
            ...
            public void askForPermission(String permissionName, int requestCode) {
                if (fragment != null) {
                    ActivityCompat.requestPermissions(fragment.getActivity(), new String[] {permissionName}, requestCode);
                } else {
        ...
        this.fileUriResolver = new FileUriResolver() {
            ...
            public Uri resolveFileProviderUriForFile(String fileProviderName, File file) {
                return FileProvider.getUriForFile(fragment!=null?fragment.getActivity():activity, fileProviderName, file);
            }

            @Override
            public void getFullImagePath(final Uri imageUri, final OnPathReadyListener listener) {
                MediaScannerConnection.scanFile(
                        fragment!=null?fragment.getActivity():activity,
    ...
    public void chooseVideoFromGallery(MethodCall methodCall, MethodChannel.Result result, Fragment fragment) {
    ...
    private void launchPickVideoFromGalleryIntent() {
        ...
        if (fragment != null) {
            fragment.startActivityForResult(pickVideoIntent, REQUEST_CODE_CHOOSE_VIDEO_FROM_GALLERY);
        } else {
    ...
    public void takeVideoWithCamera(MethodCall methodCall, MethodChannel.Result result, Fragment fragment) {
        this.fragment = fragment;
        if (!setPendingMethodCallAndResult(methodCall, result)) {
            finishWithAlreadyActiveError();
            return;
    ...
    private void launchTakeVideoWithCameraIntent() {
        ...
        if (fragment != null) {
            fragment.startActivityForResult(intent, REQUEST_CODE_TAKE_VIDEO_WITH_CAMERA);
        } else {
            activity.startActivityForResult(intent, REQUEST_CODE_TAKE_VIDEO_WITH_CAMERA);
        }
    }

    public void chooseImageFromGallery(MethodCall methodCall, MethodChannel.Result result, Fragment fragment) {
        this.fragment = fragment;
        if (!setPendingMethodCallAndResult(methodCall, result)) {
            finishWithAlreadyActiveError();
            return;
...
//    pickImageIntent.setType("image/*");
        if (fragment != null) {
            fragment.startActivityForResult(pickImageIntent, REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY);
        } else {
            activity.startActivityForResult(pickImageIntent, REQUEST_CODE_CHOOSE_IMAGE_FROM_GALLERY);
        }
    }

    public void takeImageWithCamera(MethodCall methodCall, MethodChannel.Result result, Fragment fragment) {
        this.fragment = fragment;
        if (!setPendingMethodCallAndResult(methodCall, result)) {
            finishWithAlreadyActiveError();
            return;
    ...
    private void launchTakeImageWithCameraIntent() {
        ...
        if (fragment != null) {
            fragment.startActivityForResult(intent, REQUEST_CODE_TAKE_IMAGE_WITH_CAMERA);
        } else {
